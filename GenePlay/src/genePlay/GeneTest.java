...
public class GeneTest {
	...
	while (controller !=1) {
		...
		if(optionResult == JOptionPane.YES_OPTION) {
			String str = JOptionPane.showInputDialog("Which generation? Enter a number between 0 and " + generations + ": ");
			...
			JOptionPane.showMessageDialog(new JFrame(), "You have exited the simulation. Goodbye.");
			controller = 1;
		}
	}
